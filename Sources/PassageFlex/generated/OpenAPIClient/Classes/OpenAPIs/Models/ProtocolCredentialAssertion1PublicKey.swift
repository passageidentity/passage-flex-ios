//
// ProtocolCredentialAssertion1PublicKey.swift
//
...
public struct ProtocolCredentialAssertion1PublicKey: Codable, JSONEncodable, Hashable {

    public var allowCredentials: [ProtocolCredentialAssertion1PublicKeyAllowCredentialsInner]?
    ...
    public init(allowCredentials: [ProtocolCredentialAssertion1PublicKeyAllowCredentialsInner]? = nil, challenge: String, extensions: AnyCodable? = nil, rpId: String? = nil, timeout: Int? = nil, userVerification: String? = nil) {
